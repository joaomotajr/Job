...
CREATE TABLE `tb_vendas` (
  `nota_fiscal_v` int(11) NOT NULL,
  `total_nota_v` decimal(10,0) DEFAULT NULL,
  `data_nota_v` date DEFAULT NULL,
  `cod_fun` int(11) DEFAULT NULL,
  `cod_cliente` int(11) DEFAULT NULL,
  PRIMARY KEY (`nota_fiscal_v`)
...
-- Dump completed on 2016-06-01 15:31:14
