...
CREATE TABLE `tb_itens_servicos` (
  `cod_item_s` int(11) NOT NULL,
  `nota_fiscal_s` int(11) DEFAULT NULL,
  `cod_produto` int(11) DEFAULT NULL,
  `quantidade_s` int(11) DEFAULT NULL,
  `sub_total_s` decimal(10,0) DEFAULT NULL,
  PRIMARY KEY (`cod_item_s`)
